...
const GoogleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="mr-3 h-5 w-5" viewBox="0 0 24 24">
  ...
  return (
    <main className="min-h-screen bg-[#06060e] text-white font-mono relative overflow-hidden flex items-center justify-center">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        {/* Main Grid - Only outside the card area */}
        <div 
      ...
      <div className="relative z-10 w-full max-w-[420px] px-4 py-10">
        ...
        {/* This div creates a solid background "mask" that hides the grid behind the card */}
        <div 
          className="absolute inset-x-0 top-0 bottom-0 mx-auto max-w-[420px] rounded-3xl pointer-events-none"
          style={{
            background: '#06060e',           // Same as main background
            boxShadow: '0 0 80px 40px #06060e', // Strong shadow to softly mask grid
            zIndex: -1,
          }}
        />
        ...
        <div className="relative rounded-2xl overflow-hidden"
          ...
          <div className="p-4">
            <div className="text-center mb-8">
              ...
              <p className="text-white/40 text-sm font-sans">Sign in to continue coding</p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <button
                ...
                disabled={loading}
                className="w-full h-11 flex items-center justify-center rounded-md text-sm font-medium transition-all duration-200 group relative overflow-hidden"
                style={{
              ...
              >
                <GithubIcon />
                <span className="text-white/80">Continue with GitHub</span>
              </button>

              <button
                onClick={() => handleOAuthSignIn('google')}
                disabled={loading}
                className="w-full h-11 flex items-center justify-center rounded-md text-sm font-medium transition-all duration-200"
                style={{
                  background: 'rgba(255,255,255,0.04)',
                  border: '1px solid rgba(255,255,255,0.1)',
                }}
            ...
            <div className="relative my-3">
              ...
              <div className="relative flex justify-center">
                <span className="px-4 text-[11px] text-white/30 bg-transparent tracking-widest uppercase">or</span>
              </div>
            </div>

            {/* Error */}
            {error && (
              <div className="mb-5 flex items-center gap-3 px-4 py-3 rounded-md text-sm"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    disabled={loading}
                    className="w-full h-11 px-4 rounded-sm text-sm text-white placeholder:text-white/20 outline-none transition-all duration-200 font-mono"
                    style={{
                      background: 'rgba(255,255,255,0.03)',
              ...
              <div className="pt-2 flex items-center justify-center">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full h-10 rounded-md text-sm font-semibold flex items-center justify-center gap-2 transition-all duration-200 relative overflow-hidden"
                  style={{
        ...
        {/* Sign up link */}
        <p className="text-center mt-6 text-white/30 text-sm font-sans">
