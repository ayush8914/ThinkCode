...
export type ContestProblemGroupByOutputType = {
  ...
  problemId: string
  orderIndex: number
  visibleToDivisions: $Enums.Division[]
  _count: ContestProblemCountAggregateOutputType | null
  _avg: ContestProblemAvgAggregateOutputType | null
  _sum: ContestProblemSumAggregateOutputType | null
  _min: ContestProblemMinAggregateOutputType | null
...
export type GetContestProblemGroupByPayload<T extends ContestProblemGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type ContestProblemWhereInput = {
  ...
  orderIndex?: Prisma.IntFilter<"ContestProblem"> | number
  visibleToDivisions?: Prisma.EnumDivisionNullableListFilter<"ContestProblem">
...
export type ContestProblemOrderByWithRelationInput = {
  ...
  visibleToDivisions?: Prisma.SortOrder
...
export type ContestProblemScalarWhereWithAggregatesInput = {
  ...
  orderIndex?: Prisma.IntWithAggregatesFilter<"ContestProblem"> | number
  visibleToDivisions?: Prisma.EnumDivisionNullableListFilter<"ContestProblem">
}
...
export type ContestProblemCreateInput = {
  id?: string
  orderIndex?: number
  visibleToDivisions?: Prisma.ContestProblemCreatevisibleToDivisionsInput | $Enums.Division[]
...
export type ContestProblemUpdateInput = {
  ...
  visibleToDivisions?: Prisma.ContestProblemUpdatevisibleToDivisionsInput | $Enums.Division[]
...
export type ContestProblemCreatevisibleToDivisionsInput = {
  set: $Enums.Division[]
}

export type ContestProblemUpdatevisibleToDivisionsInput = {
  set?: $Enums.Division[]
...
export type ContestProblemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "contestId" | "problemId" | "orderIndex" | "visibleToDivisions", ExtArgs["result"]["contestProblem"]>
...
export interface ContestProblemFieldRefs {
  ...
  readonly orderIndex: Prisma.FieldRef<"ContestProblem", 'Int'>
  readonly visibleToDivisions: Prisma.FieldRef<"ContestProblem", 'Division[]'>
}
